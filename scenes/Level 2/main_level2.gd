...
#preload obstacles
var stump_scene = preload("res://scenes/Level 2/stump.tscn")
var rock_scene = preload("res://scenes/Level 2/rock.tscn")
var font_scene = preload("res://scenes/Level 2/font.tscn")
var bird_scene = preload("res://scenes/Level 2/bird.tscn")
var obstacle_types := [stump_scene, rock_scene, font_scene]
var obstacles : Array
var bird_heights := [200, 390]

#game variables
const explorer_START_POS := Vector2i(150, 485)
...
func new_game():
	...
	#reset the nodes
	$explorer.position = explorer_START_POS
...
func check_high_score():
	if score > high_score:
		high_score = score
		$HUD.get_node("HighScoreLabel").text = "RECORD: " + str(high_score / SCORE_MODIFIER)
